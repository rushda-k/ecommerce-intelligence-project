...
│
├── 01_data_inspection
│   └── Python/Jupyter analysis notebook
│
├── 07_Screenshots
│   ├── 01_Executive_Overview.png
│   ├── 02_Revenue_Product_Intelligence.png
│   └── 03_Delivery_Customer_Intelligence.png
│
├── Ecommerce_Intelligence_Dashboard.pbix
│
└── README.md
📈 Power BI Dashboard
...
Provides a high-level view of overall e-commerce performance, including key business KPIs and trends.

2. Revenue & Product Intelligence

Analyzes revenue, product categories, payment behavior, and product performance.

3. Delivery & Customer Intelligence

Analyzes delivery performance, seller performance, and the relationship between delivery time and customer reviews.
...
Delivery & Customer Intelligence
...
One important finding from the delivery analysis was:

Orders that were delivered late experienced an average delay of approximately 9.55 days.
...
Built as a portfolio project demonstrating an end-to-end data analytics workflow using Python, SQL, and Power BI.
